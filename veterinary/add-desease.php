...
move_uploaded_file($_FILES["img1"]["tmp_name"],"../admin/img/deseaseimages/".$_FILES["img1"]["name"]);
move_uploaded_file($_FILES["img2"]["tmp_name"],"../admin/img/deseaseimages/".$_FILES["img2"]["name"]);
move_uploaded_file($_FILES["img3"]["tmp_name"],"../admin/img/deseaseimages/".$_FILES["img3"]["name"]);
move_uploaded_file($_FILES["img4"]["tmp_name"],"../admin/img/deseaseimages/".$_FILES["img4"]["name"]);
move_uploaded_file($_FILES["img5"]["tmp_name"],"../admin/img/deseaseimages/".$_FILES["img5"]["name"]);
